...
export type UserFormData = z.infer<typeof formSchema> //z infer  automatically detect zod for formSchema 
...
const UserProfileForm = ({onSave, isLoading, currentUser}: Props) => {
    const form  = useForm<UserFormData>({
        ...
        defaultValues: currentUser //to make inital default values in form 
    })  
